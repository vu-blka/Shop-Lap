		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-lg-5 col-md-6">
					<form:form
						action="${pageContext.request.contextPath}/user/change-password.htm"
						method="post" modelAttribute="changePassword">
						<p style="color: red; font-size: 20px">ĐỔI MẬT KHẨU</p>
						...
						<a id="buttonA"
							style='border: none; max-width: 100px; display: block; margin-left: 30px; margin-top: 10px; padding: 5px 10px; width: 100%; border-radius: 5px; cursor: pointer; background-color: #d31531; color: #ffffff; -webkit-transition: 0.5s; transition: 0.5s;'
				...
				<div class="col-lg-3 col-md-6">
					<button
						style='border: none; display: block; max-width: 300px; margin-left: 30px; margin-top: 25px; padding: 10px 10px; border-radius: 5px; cursor: pointer; background-color:; color: #ffffff; -webkit-transition: 0.5s; transition: 0.5s;'>
						<a href="user/my-account.htm">Thay đổi thông tin cá nhân</a>
					</button>
				</div>
			</div>
		</div>
